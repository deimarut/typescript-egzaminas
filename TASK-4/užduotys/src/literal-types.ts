...
console.group('Literal types - užduotys');
{
  ...
  console.group('1. Sukurkite konkrečius 5 didžiausių Vokietijos miestų tipus. Sukurkite tipą, kurio reikšmė būtų viena iš miestų.');
  {
    const city: GermanyCity = 'Berlin';
